...
//
bool ofApp::rayIntersectPlane(const ofVec3f &rayPoint, const ofVec3f &raydir, const ofVec3f &planePoint,
...
//		lander.setRotation(1, 180, 1, 0, 0);
		...
		float distance;
        glm::vec3 zeroMatrix = glm::vec3(0,0,0);
		bool hit = glm::intersectRayPlane(origin, mouseDir, zeroMatrix, camAxis, distance);
